...
#: ¿Por qué de −1 a +1 y no de 0 a 1? Por SIMETRÍA (el centro queda en {xi} = 0) y porque la cuadratura de Gauss —con la que se integra la rigidez— vive justo en ese tramo. Ventaja: siempre trabajas sobre el mismo segmento, sin importar si {L} vale 2 m o 200 m. Del largo real se encarga el Jacobiano.

## 2 · Las funciones de forma
#: Cada extremo tiene su función de forma. {N1} vale 1 en el nudo 1 ({xi} = −1) y 0 en el nudo 2; {N2} al revés:
N1 = (1-xi)/2
N2 = (1+xi)/2
#: Entre las dos interpolan en línea recta: cualquier cosa (posición, desplazamiento) se arma como {N1} por su valor en el nudo 1 más {N2} por su valor en el nudo 2.
