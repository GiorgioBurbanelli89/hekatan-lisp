...
#gauss(vars)
#: Mira la tabla: la suma de los aportes y la exacta son el mismo número, aunque las figuras no se parezcan. Y los anchos suman 2, que es el intervalo entero: los pesos se lo reparten.
...
## 3 · Con UN punto de Gauss ya basta
...
## 4 · Ahora una barra que sí lo necesita
...
## 5 · El número exacto, con el motor
