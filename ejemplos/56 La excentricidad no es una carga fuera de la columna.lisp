...
#  linea(1, 2.1, 1, 1.55, "rojo")
#  poligono(1, 1.48, 0.93, 1.66, 1.07, 1.66, "rojo")
#  texto(1.12, 1.95, "P", 3.2, "i")
#  arco(1, 1.75, 0.42, 200, 340, "rojo")
#  poligono(1.42, 1.75, 1.32, 1.62, 1.32, 1.86, "rojo")
...
#  linea(1, 2.0, 1, 1.5, "rojo")
#  poligono(1, 1.44, 0.93, 1.6, 1.07, 1.6, "rojo")
#  texto(1.1, 1.88, "P", 3, "i")
#  arco(1, 1.68, 0.36, 200, 340, "rojo")
#  poligono(1.36, 1.68, 1.27, 1.57, 1.27, 1.79, "rojo")
...
#  rect(2.7, 0, 4.7, 0.3, "gruesa")
#  achurado(2.7, 0, 4.7, 0.3, "diagonal")
#  rect(3.55, 0.3, 0.3, 1.0, "gruesa")
#  linea(4.0, 2.0, 4.0, 1.5, "rojo")
#  poligono(4.0, 1.44, 3.93, 1.6, 4.07, 1.6, "rojo")
#  texto(4.12, 1.88, "P", 3, "i")
#  linea(3.7, -0.12, 3.7, 2.1, "eje")
#  cota(3.7, 1.35, 4.0, 1.35, 0.2, "e = M/P")
