...
cp engine.lisp $W/
# solo los ejemplos que están en git (una hoja suelta de Jorge, p. ej. la 68, no se publica)
rm -rf $W/ejemplos && mkdir -p $W/ejemplos && git ls-files -z 'ejemplos/*.lisp' | xargs -0 -I{} cp "{}" $W/ejemplos/ && rm -f $W/ejemplos/_*.lisp
